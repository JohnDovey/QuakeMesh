...
// and the loopback management API into a single runnable QuakeMeshHub
// instance. See "QuakeMeshHub" and Phase 2 in /plan.md.
package hubapp
...
func New(cfg Config) (*Hub, error) {
	...
	return &Hub{cfg: cfg, Identity: id, DB: db, Registry: reg, OGM: ogm, API: api}, nil
}

// Start begins the management API's HTTP server and the OGM engine.
...
// Close stops the OGM engine and management API and closes the
// registry database.
